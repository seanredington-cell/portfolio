...
export default function DarkModeToggle() {
  ...
  return (
    <motion.button
      ...
      className="hidden sm:flex fixed z-[100] w-11 h-11 sm:w-12 sm:h-12 rounded-full backdrop-blur-sm bg-white/10 dark:bg-gray-800/30 border border-white/60 dark:border-gray-700 items-center justify-center top-[20px] sm:top-[26px]"
      style={{
        right: '16px',
