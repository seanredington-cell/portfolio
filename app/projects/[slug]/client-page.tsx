                  ...
                  >
                    <div className="flex flex-col-reverse lg:flex-row gap-4 sm:gap-6">
                      ...
                      <div className="lg:w-1/2 w-full">
                        <div className="relative w-full aspect-video rounded-lg overflow-visible">
      ...
      <section className="relative py-16 sm:py-24 overflow-hidden px-4 sm:px-8 lg:px-[168px]">
        ...
        <div className="relative max-w-2xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-[#4a4a4a] dark:text-gray-400 max-w-xl mx-auto">
              I'm always interested in hearing about new projects and opportunities.
            </p>

            <div className="pt-6 grid gap-6 md:grid-cols-2 max-w-3xl mx-auto">
              {/* Email Card */}
              <motion.a
