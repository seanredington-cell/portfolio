  ...
  return (
    ...
    >
          ...
          <div className="max-w-2xl mx-auto">
            <div className="relative w-full aspect-square rounded-xl overflow-visible">
              <div className="w-full h-full relative flex items-center justify-center">
                ...
                {/* Always use flat image — avoids JS-gated isMobile layout shift */}
                {frontMatter.image ? (
      ...
      >
        <div className="max-w-2xl mx-auto">
          <style>{`
            .markdown-content h2 { color: var(--brand-color); scroll-margin-top: 64px; }
            .markdown-content ul li::before { background-color: var(--brand-color); }
            .markdown-content blockquote { border-left-color: var(--brand-color); background-color: color-mix(in srgb, var(--brand-color) 10%, transparent); }
          `}</style>
                    ...
                    <div className="flex flex-col-reverse lg:flex-row gap-4 sm:gap-6">
                      ...
                      <div className="lg:w-1/2 w-full">
                        <div className="relative w-full aspect-square rounded-lg overflow-visible">
                          {/* Always flat image — avoids isMobile layout shift */}
                          {nextProject.image ? (
